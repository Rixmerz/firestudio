...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  exportCollections: () => ipcRenderer.invoke('firestore:exportCollections'),
  ...
  // Google OAuth Export
  googleExportCollection: (params) => ipcRenderer.invoke('google:exportCollection', params),
  googleExportCollections: (params) => ipcRenderer.invoke('google:exportCollections', params),
