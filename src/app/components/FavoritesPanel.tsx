...
import { selectFavorites, removeFavorite, Favorite } from '../../app/store/slices/favoritesSlice';
...
function FavoritesPanel({ open, onClose, onOpenFavorite }: FavoritesPanelProps) {
